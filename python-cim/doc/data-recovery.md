...
## strategy
  ...
  1. if you know *nothing* about the deleted data:
     ...
     3. extract strings from unallocated pages and slack spaces and manually review.
        ...
        see the section [here](.) for a helpful wordlist.
...
it simulates an attacker that creates a malicious WMI class and uses it to store data.
...
but let's assume all we know is the name of the malicious class: `testClass`.
is any data still in the repo?
